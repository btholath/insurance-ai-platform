...
- [ ] T011 [P] Write tier tests covering both sides of every threshold — scores 0, 19, 20, 39, 40, 59, 60, 100 — asserting every score in 0–100 maps to exactly one tier with no gap or overlap, in `apps/risk/tests/test_rules.py` (FR-006, FR-007)
