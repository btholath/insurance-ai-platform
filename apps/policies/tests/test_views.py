...
URL = "/api/policies/placeholder/"
PERMITTED_ROLES = [Role.UNDERWRITER, Role.PRODUCT_MANAGER, Role.SYSTEM_ADMINISTRATOR]
ALL_ROLES = [
    Role.FRAUD_ANALYST,
...
def test_permitted_roles_allowed_200(authenticated_client, role):
    ...
    assert response.data == {"module": "policies", "status": "placeholder"}
